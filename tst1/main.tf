...
module "github-api-app-global-lb-backend" {
  ...
  project_id              = "designcenterhydropowerparts"
  serverless_neg_backends = concat([{"service_name" = "github-api-app-service", "type" = "cloud-run", "region" = "us-central1"}, {"region" = "us-central1", "service_name" = "hydro-ai-frontend-service", "type" = "cloud-run"}], [{"service_name" = module.github-api-app-service.service_name, "service_version" = "", "type" = "cloud-run", "region" = module.github-api-app-service.location}])
...
module "github-api-app-service" {
  ...
  containers                    = [{"env_secret_vars" = {"github_api_db_secret_SECRET" = module.github-api-db-secret.env_vars.SECRET}, "env_vars" = {"github_api_db_CLOUD_SQL_DATABASE_HOST" = module.github-api-db.instance_first_ip_address, "github_api_db_CLOUD_SQL_DATABASE_NAME" = module.github-api-db.env_vars.CLOUD_SQL_DATABASE_NAME, "github_api_db_CLOUD_SQL_DATABASE_CONNECTION_NAME" = module.github-api-db.instance_connection_name}, "ports" = {"container_port" = 8080}, "container_image" = "gcr.io/cloudrun/hello", "container_name" = "service-container"}]
