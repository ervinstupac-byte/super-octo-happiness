...
module "github-api-app-global-lb-backend" {
  ...
  project_id              = "designcenterhydropowerparts"
  serverless_neg_backends = concat([{"region" = "us-central1", "service_name" = "github-api-app-service", "type" = "cloud-run"}, {"region" = "us-central1", "service_name" = "hydro-ai-frontend-service", "type" = "cloud-run"}], [{"region" = module.github-api-app-service.location, "service_name" = module.github-api-app-service.service_name, "service_version" = "", "type" = "cloud-run"}])
